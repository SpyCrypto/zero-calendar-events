  ...
  return (
    <Link href={`/events/${event.id}`}
      ...
      <div className="p-4 space-y-2">
        <h3 className="font-semibold text-slate-200 line-clamp-1">{event.title}</h3>
        ...
        {/* "Who's Going" compact pill row — the network gravity signal */}
        <WhoIsGoing breakdown={event.whoIsGoing} compact />
        ...
        <div className="h-1 bg-midnight-900 rounded-full overflow-hidden">
